...
Target::Target(const char* targetFile, const char* maskFile,
               int satT1, int satT2, int valT1, int valT2, bool fuzzyEdges) :
   rgbData(NULL), hsvData(NULL), rgbMaskData(NULL), hsvMaskData(NULL),
   satEdgeMap(NULL), valEdgeMap(NULL), st1(satT1), st2(satT2), vt1(valT1),
   vt2(valT2), fuzzy(fuzzyEdges)
{
