...
TriangleCanvas::TriangleCanvas(Target* t, color_t r, color_t g, color_t b,
...
void TriangleCanvas::fastColourTechnique3(RGB targetPixel, RGB canvasPixel,
...
{
  // To check whether is theta3 and lines are the correct ones or not.
	if(applyTriangle())
	{
...
void TriangleCanvas::computeFitness()
{
  int width = getWidth();
