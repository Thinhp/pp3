...
BezierPathCanvas::BezierPathCanvas(Target* t, color_t r, color_t g, color_t b,
    BestCanvas* bc, ConfigReader* reader) : Canvas(t, r, g, b, bc),
  reader(reader), baseDivisionsPerStroke(400)
{
...
void BezierPathCanvas::setupDividedLengthPath(float f1, float f2, float f3,
    float f4, int n)
{
  // 1st end point
...
void BezierPathCanvas::setupQuarterLengthPath(float f1, float f2, float f3,
    float f4)
{
...
void BezierPathCanvas::setupHalfLengthPath(float f1, float f2, float f3,
    float f4)
{
...
void BezierPathCanvas::setupFullLengthPath(float f1, float f2, float f3,
    float f4)
{
