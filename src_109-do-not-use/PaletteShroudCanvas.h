...
#ifndef PALETTE_SHROUD_CANVAS_H
#define PALETTE_SHROUD_CANVAS_H
...
class PaletteShroudCanvas : public Canvas
{
private:
  RGB* shroud;
...
public:
  PaletteShroudCanvas(Target* t, color_t r, color_t g, color_t b,
